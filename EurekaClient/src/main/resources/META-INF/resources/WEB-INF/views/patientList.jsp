...
<div class="container wrapper1">
    ...
    <c:forEach items="${patients}" var ="patient">
        <div class="row">
            ...
            <div class="col">
                <a type="button" class="btnAction" href="/patient/${patient.id}">Detail</a>
                <a type="button" class="btnAction" href="/patient/delete/${patient.id}">Delete</a>
            </div>
        </div>
    </c:forEach>
</div>
...
<form action = "/patient/create" method = "post" >
    ...
    <div class="container createWr2" >
        ...
        <div class="row">
            ...
            <div class="col" ><input type = "text" name = "diagnosis" required ></div >
        </div>
    </div >
